...
<p  className='justify '>
At Bighatch Consulting, also known as ESERVZ, our commitment to excellence is fortified by our strategic collaborations and affiliations. These partnerships contribute to the depth of our expertise and enhance the value we deliver to our clients. We proudly highlight the following esteemed partnerships:
        </p>        
    </div>
    ...
    <div>
        <h3 className='justify m1'>
        Walmart Connect Partner
        </h3>
        <p  className='justify '>
        Website:<a href='https://www.walmartconnect.com/partners 
 ' target='blank'>https://www.walmartconnect.com/partners 
 </a>
        </p>
        <p  className='justify m1'>
    ...
    <div>
        ...
        <p  className='justify '>
        Website:<a href='https://www.google.com/partners ' target='blank'> https://www.google.com/partners </a>
        </p>
        <p  className='justify m1'>
        As Google Partners, we harness the power of data-driven insights to optimize your online presence and drive success.
        </p>
