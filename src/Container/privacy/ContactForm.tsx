...
const ContactForm = () => {
  return (
    ...
    >
    <h1>Request a Quote or Contact Form</h1>
    </div>
    <div>
    ...
    <div>
        <h2 className='justify m1'>How It Works: </h2>
        <h4 className='justify m1'> Submit Your Inquiry: </h4>
        <p  className='justify '>
        Submit Your Inquiry: Simply fill out the required details in our user-friendly contact form. We encourage you to provide as much information as possible to help us understand your objectives and requirements.
        </p>
        <h4 className='justify m1'>Personalized Response: </h4>
        <p  className='justify '>
         Once we receive your inquiry, our dedicated team will review your details and craft a tailored response. We understand that each business is unique, and our solutions are designed to address your specific challenges and goals.
        </p>
        <h4 className='justify m1'>Customized Quote: </h4>
        <p  className='justify '>
         If you are interested in our services, we will provide you with a customized quote that outlines the scope of work, deliverables, timelines, and associated costs. This quote will serve as a blueprint for our collaboration.
        </p>
        <h4 className='justify m1'> Transparent Communication: </h4>
        <p  className='justify '>
         We believe in transparent communication. If you have any questions or require further clarification about the quote or our services, our team is readily available to provide the information you need.
        </p>
