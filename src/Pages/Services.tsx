  ...
  return (
    <div>
        ...
        <div className='about-content-container'>
          ...
          Furthermore, we specialize in crafting ecommerce websites and applications using platforms such as<b> Magento, Shopify, and BigCommerce. </b><br/><br/> Additionally, our expertise extends to offering comprehensive accounting and bookkeeping services through <b>Quickbooks</b>.<br/><br/>
