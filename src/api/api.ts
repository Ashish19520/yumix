...
export const fetchNews1=()=>API.get(`api/latest-newsses/rss-feed`);
export const fetchNews2=()=>API.get(`api/latest-newsses/shopify`);
export const fetchNews3=()=>API.get(`api/latest-newsses/store-factory`);
export const fetchNews4=()=>API.get(`api/latest-newsses/latest-news`);
export const fetchNews5=()=>API.get(`api/latest-newsses/marketingword`);
